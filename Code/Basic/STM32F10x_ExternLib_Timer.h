...
typedef struct TIM_PeriphTypeDef{
    ...
    void (*interruptUpdateCallback)(void *);//回调函数
...
TIM_Object TIM_InitializeAdvance(TIM_TypeDef *TIMx, uint16_t period, uint16_t prescaler, void (*interruptUpdateCallback)(GenericObject), GenericObject interruptUpdateCallbackParam,int8_t IRQnChannel, uint8_t preemptionPriority, uint8_t subPriority);
